...
if(EXISTS "${_prefix}/include/libxstream/opencl")
  set(LIBXSTREAM_INCLUDE_DIRS "${_prefix}/include/libxstream")
elseif(EXISTS "${_prefix}/libxstream/opencl")
  set(LIBXSTREAM_INCLUDE_DIRS "${_prefix}/libxstream")
else()
  set(LIBXSTREAM_INCLUDE_DIRS "${_prefix}/include")
endif()
