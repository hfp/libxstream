        ...
        if (EXIT_SUCCESS == result) {
          ...
          if (NULL != tname) {
            ...
            const int unroll = LIBXSMM_MAX(-2, (NULL == env_lu || '\0' == *env_lu)
                                                 ? (NULL == config ? default_lu : config->lu)
            ...
            new_config.nz = LIBXSMM_CLMP((NULL == env_nz || '\0' == *env_nz)
                                           ? (0 != defaults ? /*default*/ 0 : config->nz)
                                           : atoi(env_nz),
              0, 1);
